...
(function($) {
        ...
        if (_.options.arrows === true ) {
            ...
            if( _.slideCount > _.options.slidesToShow ) {
                ...
                if (_.options.infinite !== true) {
                    _.$prevArro.addClass('slick-disabled').attr('aria-disabled', 'true');
                }
    ...
    Slick.prototype.focusHandler = function() {
        ...
        _.$slider.off('focus.slick blur.slick').on('focus.slick','*',function(event) {var $sf = $(this);setTimeout(function() {
            ...
            ).on('blur.slick','*',function(event) {var $sf = $(this);
    ...
    Slick.prototype.swipeHandler = function(event) {
        ...
        switch (event.data.action) {
            ...
            case 'start':_.swipeStart(event);
                break;

            case 'move':_.swipeMove(event);
                break;

            case 'end':_.swipeEnd(event);
                break;
        }
    };
